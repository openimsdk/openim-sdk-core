...
func SetFriendPin(callback open_im_sdk_callback.Base, operationID string, friendIDsAndIsPinned string) {
	call(callback, operationID, UserForSDK.Friend().SetFriendsPin, friendIDsAndIsPinned)
}
