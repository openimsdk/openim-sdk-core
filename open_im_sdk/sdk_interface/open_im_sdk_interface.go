...
func InitSDK(config string, cb open_im_sdk.IMSDKListener) bool {
	var sc open_im_sdk.IMConfig
	...
	open_im_sdk.userForSDK = new(open_im_sdk.UserRelated)

	open_im_sdk.InitOnce(&sc)
...
func Login(uid, tk string, callback open_im_sdk.Base) {
	if open_im_sdk.userForSDK == nil {
		utils.sdkLog("userForSDK nil")
		if callback != nil {
			callback.OnError(open_im_sdk.ErrCodeInitLogin, "userForSDK nil, initSdk first ")
		}
		return
	}
...
func Logout(callback open_im_sdk.Base) {
	if open_im_sdk.userForSDK == nil {
		utils.sdkLog("userForSDK nil")
		if callback != nil {
			callback.OnError(open_im_sdk.ErrCodeInitLogin, "userForSDK nil, initSdk first ")
...
func CreateGroup(callback open_im_sdk.Base, gInfo string, memberList string, operationID string) {
	open_im_sdk.userForSDK.CreateGroup(callback, gInfo, memberList, operationID)
}

func JoinGroup(groupId, message string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.JoinGroup(groupId, message, callback)
}

func QuitGroup(groupId string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.QuitGroup(groupId, callback)
}

func GetJoinedGroupList(callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.GetJoinedGroupList(callback)
}

func GetGroupsInfo(groupIdList string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.GetGroupsInfo(groupIdList, callback)
}

func SetGroupInfo(jsonGroupInfo string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.SetGroupInfo(jsonGroupInfo, callback)
}

func GetGroupMemberList(groupId string, filter int32, next int32, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.GetGroupMemberList(groupId, filter, next, callback)
}

func GetGroupMembersInfo(groupId string, userList string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.GetGroupMembersInfo(groupId, userList, callback)
}

func KickGroupMember(groupId string, reason string, userList string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.KickGroupMember(groupId, reason, userList, callback)
}

func TransferGroupOwner(groupId, userId string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.TransferGroupOwner(groupId, userId, callback)
}

func InviteUserToGroup(groupId, reason string, userList string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.InviteUserToGroup(groupId, reason, userList, callback)
}

func GetGroupApplicationList(callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.GetGroupApplicationList(callback)
}

func AcceptGroupApplication(application, reason string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.AcceptGroupApplication(application, reason, callback)
}

func RefuseGroupApplication(application, reason string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.RefuseGroupApplication(application, reason, callback)
}

/////////////////////////////////////////////////////////////////

func GetDesignatedFriendsInfo(callback open_im_sdk.Base, userIDList, operationID string) {
	open_im_sdk.userForSDK.GetDesignatedFriendsInfo(callback, userIDList, operationID)
}

func GetFriendList(callback open_im_sdk.Base, operationID string) {
	open_im_sdk.userForSDK.GetFriendList(callback, operationID)
}

func CheckFriend(callback open_im_sdk.Base, userIDList, operationID string) {
	open_im_sdk.userForSDK.CheckFriend(callback, userIDList, operationID)
}

func AddFriend(callback open_im_sdk.Base, paramsReq, operationID string) {
	open_im_sdk.userForSDK.AddFriend(callback, paramsReq, operationID)
}

func SetFriendRemark(callback open_im_sdk.Base, params, operationID string) {
	open_im_sdk.userForSDK.SetFriendRemark(callback, params, operationID)
}
func DeleteFriend(callback open_im_sdk.Base, friendUserID, operationID string) {
	open_im_sdk.userForSDK.DeleteFriend(callback, friendUserID, operationID)
}

func GetRecvFriendApplicationList(callback open_im_sdk.Base, operationID string) {
	open_im_sdk.userForSDK.GetRecvFriendApplicationList(callback, operationID)
}

func GetSendFriendApplicationList(callback open_im_sdk.Base, operationID string) {
	open_im_sdk.userForSDK.GetSendFriendApplicationList(callback, operationID)
}

func AcceptFriendApplication(callback open_im_sdk.Base, params string, operationID string) {
	open_im_sdk.userForSDK.AcceptFriendApplication(callback, params, operationID)
}

func RefuseFriendApplication(callback open_im_sdk.Base, params, operationID string) {
	open_im_sdk.userForSDK.RefuseFriendApplication(callback, params, operationID)
}

func AddBlack(callback open_im_sdk.Base, blackUserID, operationID string) {
	open_im_sdk.userForSDK.AddBlack(callback, blackUserID, operationID)
}

func GetBlackList(callback open_im_sdk.Base, operationID string) {
	open_im_sdk.userForSDK.GetBlackList(callback, operationID)
}

func RemoveBlack(callback open_im_sdk.Base, removeUserID, operationID string) {
...
func GetAllConversationList(callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.GetAllConversationList(callback)
}
func GetConversationListSplit(callback open_im_sdk.Base, offset, count int) {
	open_im_sdk.userForSDK.GetConversationListSplit(callback, offset, count)
}
func SetConversationRecvMessageOpt(callback open_im_sdk.Base, conversationIDList string, opt int) {
	open_im_sdk.userForSDK.SetConversationRecvMessageOpt(callback, conversationIDList, opt)
}

func GetConversationRecvMessageOpt(callback open_im_sdk.Base, conversationIDList string) {
	open_im_sdk.userForSDK.GetConversationRecvMessageOpt(callback, conversationIDList)
}
func GetOneConversation(sourceID string, sessionType int, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.GetOneConversation(sourceID, sessionType, callback)
}
func GetMultipleConversation(conversationIDList string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.GetMultipleConversation(conversationIDList, callback)
}
func DeleteConversation(conversationID string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.DeleteConversation(conversationID, callback)
}
func SetConversationDraft(conversationID, draftText string, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.SetConversationDraft(conversationID, draftText, callback)
}
func PinConversation(conversationID string, isPinned bool, callback open_im_sdk.Base) {
	open_im_sdk.userForSDK.PinConversation(conversationID, isPinned, callback)
}
func GetTotalUnreadMsgCount(callback open_im_sdk.Base) {
...
func RevokeMessage(callback open_im_sdk.Base, message string) {
...
func MarkC2CMessageAsRead(callback open_im_sdk.Base, receiver string, msgIDList string) {
	open_im_sdk.userForSDK.MarkC2CMessageAsRead(callback, receiver, msgIDList)
}

//Deprecated
func MarkSingleMessageHasRead(callback open_im_sdk.Base, userID string) {
	open_im_sdk.userForSDK.MarkSingleMessageHasRead(callback, userID)
}
func MarkGroupMessageHasRead(callback open_im_sdk.Base, groupID string) {
	open_im_sdk.userForSDK.MarkGroupMessageHasRead(callback, groupID)
}
func DeleteMessageFromLocalStorage(callback open_im_sdk.Base, message string) {
	open_im_sdk.userForSDK.DeleteMessageFromLocalStorage(callback, message)
}
func ClearC2CHistoryMessage(callback open_im_sdk.Base, userID string) {
	open_im_sdk.userForSDK.ClearC2CHistoryMessage(callback, userID)
}
func ClearGroupHistoryMessage(callback open_im_sdk.Base, groupID string) {
	open_im_sdk.userForSDK.ClearGroupHistoryMessage(callback, groupID)
}
func InsertSingleMessageToLocalStorage(callback open_im_sdk.Base, message, userID, sender string) string {
	return open_im_sdk.userForSDK.InsertSingleMessageToLocalStorage(callback, message, userID, sender)
}

func FindMessages(callback open_im_sdk.Base, messageIDList string) {
	open_im_sdk.userForSDK.FindMessages(callback, messageIDList)
}

func GetUsersInfo(uIDList string, cb open_im_sdk.Base) {
	open_im_sdk.userForSDK.GetUsersInfo(uIDList, cb)
}

func SetSelfInfo(info string, cb open_im_sdk.Base) {
