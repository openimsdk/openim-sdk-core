...
func (u *open_im_sdk.UserRelated) doGroupMsg(msg *open_im_sdk.MsgData) {
	...
	go func() {
		...
		case open_im_sdk.TransferGroupOwnerTip:
			u.doTransferGroupOwner(msg)
		case open_im_sdk.CreateGroupTip:
			u.doCreateGroup(msg)
		case open_im_sdk.JoinGroupTip:
			u.doJoinGroup(msg)
		case open_im_sdk.QuitGroupTip:
			u.doQuitGroup(msg)
		case open_im_sdk.SetGroupInfoTip:
			u.doSetGroupInfo(msg)
		case open_im_sdk.AcceptGroupApplicationTip:
			u.doAcceptGroupApplication(msg)
		case open_im_sdk.RefuseGroupApplicationTip:
			u.doRefuseGroupApplication(msg)
		case open_im_sdk.KickGroupMemberTip:
			u.doKickGroupMember(msg)
		case open_im_sdk.InviteUserToGroupTip:
...
func (u *open_im_sdk.UserRelated) doCreateGroup(msg *open_im_sdk.MsgData) {
	var n open_im_sdk.NotificationContent
...
func (u *open_im_sdk.UserRelated) doAcceptGroupApplication(msg *open_im_sdk.MsgData) {
	...
	var acceptInfo open_im_sdk.GroupApplicationInfo
	var acceptContent open_im_sdk.NotificationContent
...
func (u *open_im_sdk.UserRelated) doRefuseGroupApplication(msg *open_im_sdk.MsgData) {
	...
	var refuseInfo open_im_sdk.GroupApplicationInfo
	var refuseContent open_im_sdk.NotificationContent
...
func (u *open_im_sdk.UserRelated) doKickGroupMember(msg *open_im_sdk.MsgData) {
	var notification open_im_sdk.NotificationContent
