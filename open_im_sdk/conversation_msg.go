...
func SetConversationEx(callback open_im_sdk_callback.Base, operationID string, ex string) {
	call(callback, operationID, UserForSDK.Conversation().SetOneConversationEx, ex)
}
