...
func (u *open_im_sdk.UserRelated) tencentOssCredentials() (*open_im_sdk.paramsTencentOssCredentialResp, error) {
...
func (ur *open_im_sdk.UserRelated) uploadImage(filePath string, back SendMsgCallBack) (string, string, error) {
...
func (ur *open_im_sdk.UserRelated) uploadSound(filePath string, back SendMsgCallBack) (string, string, error) {
	ossResp, err := ur.tencentOssCredentials()
	if err != nil {
...
func (ur *open_im_sdk.UserRelated) uploadFile(filePath string, back SendMsgCallBack) (string, string, error) {
	ossResp, err := ur.tencentOssCredentials()
	if err != nil {
		utils.sdkLog(err.Error())
		return "", "", err
...
func (ur *open_im_sdk.UserRelated) uploadVideo(videoPath, snapshotPath string, back SendMsgCallBack) (string, string, string, string, error) {
