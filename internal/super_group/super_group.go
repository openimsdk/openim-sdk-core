...
func (s *SuperGroup) getJoinedGroupListFromSvr(ctx context.Context) ([]*sdkws.GroupInfo, error) {
	fn := func(resp *group.GetJoinedGroupListResp) []*sdkws.GroupInfo { return resp.Groups }
	req := &group.GetJoinedGroupListReq{FromUserID: s.loginUserID, Pagination: &sdkws.RequestPagination{}}
