...
type MessageModel interface {
	...
	SearchMessageBySenderUserID(ctx context.Context, contentType []int, SenderUserIDList []string, conversationID string, startTime, endTime int64, offset, count int) (result []*model_struct.LocalChatLog, err error)
	...
	SearchMessageByContentTypeAndSenderUserID(ctx context.Context, contentType []int, conversationID string, SenderUserIDList []string, startTime, endTime int64) (result []*model_struct.LocalChatLog, err error)
